...
export class Backend implements backendInterface {
    ...
    async retrieveBackup(): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.retrieveBackup();
    ...
    async syncBackup(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.syncBackup(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
